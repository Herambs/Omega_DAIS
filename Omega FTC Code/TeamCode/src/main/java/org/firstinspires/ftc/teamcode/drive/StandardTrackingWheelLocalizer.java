...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 14.2; // in; distance between the left and right wheels(13.13)
    public static double FORWARD_OFFSET = -8.30; // in; offset of the lateral wheel
