...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 13; // in; distance between the left and right wheels(13.13)
    ...
    public static double X_MULTIPLIER = 1.026; // Multiplier in the X direction
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap, List<Integer> lastTrackingEncPositions, List<Integer> lastTrackingEncVels) {
        ...
        leftEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "Back_intake"));
